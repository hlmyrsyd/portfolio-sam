...
export default function Hero() {
    ...
    return (
        <div className="w-full h-screen flex flex-col justify-center items-center gap-8">
            <div   
                className="font-bold text-[6rem] flex flex-col items-center">
                <motion.h1 
                ...
                <div className='text-[1.5rem] font-normal flex flex-row'>
                    <motion.h2
            ...
            >
                <motion.div 
                    ...
                    className="border py-1 px-4 rounded-xl shadow-inner-white border-neutral-800 cursor-none hover:bg-neutral-200 hover:text-neutral-800"
                >
            ...
            <div className='p-6 flex flex-row gap-6 h-32 w-full justify-center'>
                ...
                >
                    <div 
                        className="w-20 border bg-neutral-900 border-neutral-900 p-4 rounded-xl shadow-inner-white flex items-center  cursor-none text-white hover:bg-neutral-200 hover:text-[#3178C6] hover:p-3 transition-all ease-in-out delay-200"
                    >
                        <svg 
                            width="60" 
                            height="60" 
                ...
                >
                    <div
                        className="w-20 border bg-neutral-900 border-neutral-900 p-4 rounded-xl shadow-inner-white flex items-center cursor-none hover:bg-neutral-200 hover:p-3 transition-all delay-200 text-white custom-hover "
                    >
                        <svg 
                            width="60" 
                            height="60" 
                ...
                <motion.div
                    ...
                    className='flex justify-center'
                >
                    <div className="w-20 border bg-neutral-900 border-neutral-900 p-4 rounded-xl shadow-inner-white flex items-center  cursor-none text-white hover:bg-neutral-200 hover:text-[#336791] hover:p-3 transition-all ease-in-out delay-200"
                    >
                        <svg 
                            fill="currentColor" 
                            width="60" 
                ...
                <motion.div
                    ...
                    className='flex justify-center'
                >
                    <div className="w-20 border bg-neutral-900 border-neutral-900 p-4 rounded-xl shadow-inner-white flex items-center  cursor-none text-white hover:bg-neutral-200 hover:text-orange-500 hover:p-3 transition-all ease-in-out delay-200"
                    >
                        <svg 
                            width="60" 
                            height="60" 
                ...
                <motion.div
                    ...
                    className='flex justify-center'
                >
                    <div className="w-20 border bg-neutral-900 border-neutral-900 p-4 rounded-xl shadow-inner-white flex items-center  cursor-none text-green-100 hover:bg-neutral-200 custom-hover hover:p-3 transition-all ease-in-out delay-200"
                    >
                        <svg 
                            width="60" 
                            height="60" 
